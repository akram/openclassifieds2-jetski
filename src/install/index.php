                                    ...
                                    <?if($is_compatible === TRUE):?>
                                        ...
                                        <div class="panel-2">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="DB_HOST" name="DB_HOST" class="form-control" value="<?=core::request('DB_HOST',getenv('MYSQL_PORT_3306_TCP_ADDR'))?>" required>
                                            </div>
                                            <div class="form-group">                
                                                <label for="DB_NAME" class="control-label"><?=__("Database name")?></label>
																								<input type="text" id="DB_NAME" name="DB_NAME" class="form-control" 
																								       value="<?=core::request('DB_NAME', core::request('MYSQL_ENV_MYSQL_DATABASE','openclassifieds'))?>" required>
                                            ...
                                            <div class="form-group">                
                                                ...
                                                <input type="text" id="DB_PASS" name="DB_PASS" class="form-control" value="<?=core::request('DB_PASS', getenv('MYSQL_ENV_MYSQL_ROOT_PASSWORD'))?>">
                                            </div>
                                            <div class="checkbox">
                                                <label>
                                            ...
                                            <div class="panel-3">
                                                ...
                                                <div class="form-group">
                                                    <label for="SITE_NAME" class="control-label"><?=__("Site Name")?></label>
																										<input type="text" id="SITE_NAME" name="SITE_NAME" class="form-control" placeholder="<?=__("Site Name")?>" 
																										       value="<?=core::request('SITE_NAME', getenv('OC_SITE_NAME'))?>" required>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <label for="ADMIN_EMAIL" class="control-label"><?=__("Administrator email")?></label>
																										<input type="email" id="ADMIN_EMAIL" name="ADMIN_EMAIL" class="form-control" 
																										       value="<?=core::request('ADMIN_EMAIL', getenv('OC_ADMIN_EMAIL'))?>" placeholder="your@email.com" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="ADMIN_PWD" class="control-label"><?=__("Admin Password")?></label>
																										<input type="text" id="ADMIN_PWD" name="ADMIN_PWD" class="form-control" 
																										       value="<?=core::request('ADMIN_PWD', getenv('OC_ADMIN_PWD'))?>" required>
                                                </div>
                                                <div class="form-group hidden animated site-adv">
